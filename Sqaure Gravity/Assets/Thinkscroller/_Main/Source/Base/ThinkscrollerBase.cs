...
namespace ThinksquirrelSoftware.Thinkscroller
{
	...
	/// </summary>
	public abstract class ThinkscrollerBase : MonoBehaviour
	{
		#region Private fields
		[SerializeField] [HideInInspector] Transform m_CachedTransform					= null;
		//! \cond PRIVATE
		[HideInInspector] public bool _EDITOR_foldout								 	= true;
		[HideInInspector] public bool _EDITOR_supportsSaveAndLoad						= true;
		//! \endcond
		#endregion
